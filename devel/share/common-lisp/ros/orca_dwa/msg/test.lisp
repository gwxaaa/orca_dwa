...
(cl:defmethod cl:initialize-instance :after ((m <test>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'test)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name orca_dwa-msg:<test> is deprecated: use orca_dwa-msg:test instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orca_dwa-msg:data-val is deprecated.  Use orca_dwa-msg:data instead.")
  (data m))

(cl:ensure-generic-function 'vel-val :lambda-list '(m))
(cl:defmethod vel-val ((m <test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orca_dwa-msg:vel-val is deprecated.  Use orca_dwa-msg:vel instead.")
  (vel m))

(cl:ensure-generic-function 'Pose-val :lambda-list '(m))
(cl:defmethod Pose-val ((m <test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orca_dwa-msg:Pose-val is deprecated.  Use orca_dwa-msg:Pose instead.")
  (Pose m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <test>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader orca_dwa-msg:name-val is deprecated.  Use orca_dwa-msg:name instead.")
  (name m))
